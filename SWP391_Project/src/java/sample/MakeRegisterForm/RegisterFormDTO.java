 ...
 */
package sample.MakeRegisterForm;
...
public class RegisterFormDTO {
    ...
    public RegisterFormDTO(int registerID, String majorID, String narrowID, String semesterID, Timestamp importDate, Timestamp usingDate, int minQuantity) {
